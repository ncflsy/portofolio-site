...
const Profile = () => {
  ...
  return (
    <>
      ...
      <section id="profile" className="bg-black  text-whiteText">
        <div className="px-[50px] md:px-[200px] py-[100px]">
          <div className="lg:flex w-full md:gap-12">
            ...
            <div className="max-w-[300px] md:max-w-[500px] mx-auto text-white">
              <h1 className="text-white font-semibold text-[30px] md:text-[50px] leading-[40px] md:leading-[60px]">
                Information <span className="text-red">Technology</span> Student
              </h1>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia
                architecto voluptate accusamus modi at, rerum atque obcaecati
                iste officiis non. Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Nihil, praesentium.
              </p>
