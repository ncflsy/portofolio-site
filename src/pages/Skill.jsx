...
const Skill = () => {
  ...
  return (
    <>
      ...
      <section
        id="skill"
        className="bg-black text-white px-[50px] md:px-[200px] py-[100px]"
      >
        <div className="flex flex-col-reverse lg:flex-row justify-center gap-4">
          <div className="max-w-[600px]">
            <h1 className="text-white text-[30px] md:text-[40px] leading-[40px] md:leading-[60px]">
            ...
            <div className="flex flex-col gap-4">
              <div className="mt-4 flex flex-col gap-2 relative max-w-[400px]">
                ...
                <div className="w-[160px] md:w-[320px] h-2 bg-red rounded-full top-8 left-0 absolute"></div>
              ...
              <div className="mt-4 flex flex-col gap-2 relative max-w-[400px]">
                <p>UI Design</p>
                <div className="w-[175px] md:w-[350px] h-2 bg-white rounded-full top-8 left-0 absolute"></div>
                <div className="w-[150px] md:w-[300px] h-2 bg-red rounded-full top-8 left-0 absolute"></div>
                <span className="absolute top-6 right-0">
                  {calculatePercentage(300, 350)}%
                </span>
              </div>
              <div className="mt-4 flex flex-col gap-2 relative max-w-[400px]">
                <p>Graphic Design</p>
                <div className="w-[175px] md:w-[350px] h-2 bg-white rounded-full top-8 left-0 absolute"></div>
                <div className="w-[125px] md:w-[250px] h-2 bg-red rounded-full top-8 left-0 absolute"></div>
                <span className="absolute top-6 right-0">
                  {calculatePercentage(250, 350)}%
                </span>
              </div>
              <div className="mt-4 flex flex-col gap-2 relative max-w-[400px]">
                <p>Web Development</p>
